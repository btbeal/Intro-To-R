---
title: "Lesson 4 - Functions and Loops in R"
author: "Brennan T. Beal, PharmD, MS"
date: 2020-07-01T21:13:14-02:00
categories: ["R"]
output:
  blogdown::html_page
draft: FALSE
...
Note that I told R that it should loop 6 times `1:6` but that isn't very flexible. A new function, `length()` can tell us how long our vector is so we don't have to count.\
